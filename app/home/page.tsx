...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen font-sans text-white relative" style={{ animation: 'pageFadeIn 0.4s ease forwards' }}>
      ...
      {/* ══ VIDEO BACKGROUND — always visible behind content ══ */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Dark overlay — enough to read text, light enough to see video */}
      ...
      <div className="relative z-10">
        ...
        {/* Story section — transparent so video shows through */}
        <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-12 lg:px-16">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            <div>
              <span className="inline-flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-white/50 mb-4">
                <BookOpen size={14} /> Our Story
              </span>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-5 sm:mb-6 text-white drop-shadow-lg">
                Built on conviction.<br />Driven by purpose.
              </h2>
              <p className="text-white/80 leading-relaxed mb-5 sm:mb-6 text-sm sm:text-base drop-shadow">
              ...
              <p className="text-white/70 leading-relaxed mb-6 sm:mb-8 text-sm sm:text-base drop-shadow">
              ...
              <button onClick={() => router.push('/investing')}
                className="inline-flex items-center gap-2 bg-white text-black px-6 sm:px-7 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm sm:text-base shadow-lg">
              ...
              {[
                ...
                <div key={i} className="flex gap-5 sm:gap-6 group">
                  <div className="flex flex-col items-center">
                    ...
                    {i < arr.length - 1 && <div className="w-px flex-1 bg-white/30 mt-1" />}
                  </div>
                  <div className="pb-4">
                    <span className="text-xs text-white/40 font-mono">{item.year}</span>
                    <p className="font-semibold text-white mt-0.5 text-sm sm:text-base drop-shadow">{item.title}</p>
                    <p className="text-xs sm:text-sm text-white/60 mt-1 drop-shadow">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Stats */}
          <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 mt-14 sm:mt-20 pt-10 sm:pt-12 border-t border-white/20">
            {[
              ...
              <div key={i} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-5 border border-white/15">
                <p className="text-2xl sm:text-3xl font-bold mb-1 text-white">{s.value}</p>
        ...
        {/* Page nav */}
        <div className="px-4 sm:px-6 md:px-12 lg:px-16 py-10 sm:py-12 border-t border-white/20">
          <div className="max-w-7xl mx-auto flex justify-end">
            <button onClick={() => router.push('/investing')}
              className="flex items-center gap-2 bg-white text-black px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm shadow-lg">
...
function PageFooter() {
  return (
    <footer className="border-t border-white/20 py-10 px-4 sm:px-6 md:px-12 lg:px-16 bg-black/40 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-2xl font-bold text-white">VEX</p>
        <p className="text-sm text-white/40">&copy; 2026 VEX Group. All rights reserved.</p>
