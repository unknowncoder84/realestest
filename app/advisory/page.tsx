...
import { ArrowRight, Lightbulb, Mail, Phone, MapPin, Users, ArrowUpRight, ChevronRight } from 'lucide-react'
...
export default function AdvisoryPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      {/* ══ RIVR-STYLE GLASSMORPHISM HERO BG ══ */}
      <div className="w-full h-screen flex items-center justify-center p-3 md:p-5 bg-[#f0f0f0]">
        <section className="relative w-full max-w-[1536px] h-full rounded-[1.5rem] md:rounded-[3rem] overflow-hidden shadow-none flex flex-col items-center bg-white/10 group">
          ...
          {/* Video background — pure effect, no text */}
          <video
          ...
          <div className="relative z-10 w-full h-full flex flex-col items-center">
            ...
            {/* Advisory hero text — centred over the video */}
            <div className="flex-1 flex flex-col items-center justify-center text-center px-6">
              <motion.span
                initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, ease: 'easeOut' }}
                className="inline-flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-white/60 mb-5"
              >
              ...
              <motion.h1
                ...
                className="text-5xl sm:text-6xl md:text-7xl lg:text-[88px] font-light text-white leading-[1.04] mb-5"
              ...
              <motion.p
                ...
                className="text-base md:text-lg text-white/60 max-w-xl leading-relaxed font-light"
              >
            ...
            >
              <div className="flex flex-col">
                <span className="text-2xl md:text-3xl font-normal text-[rgba(30,50,90,0.9)] tracking-tight">200+</span>
                <span className="text-[10px] md:text-[12px] font-normal text-[rgba(30,50,90,0.6)] uppercase tracking-wider">Advisory Mandates</span>
              </div>
              <motion.button
              ...
              >
                ...
                <span className="text-[14px] font-normal text-[rgba(30,50,90,0.9)]">Work with us</span>
              </motion.button>
            </motion.div>
            ...
            >
              ...
              {/* Info */}
              <div className="flex flex-col">
                <span className="text-[16px] md:text-[20px] font-normal text-[rgba(30,50,90,0.95)]">Our Services</span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start mb-24">
            <div>
              ...
              <button className="bg-black text-white px-7 py-3 rounded-lg font-medium hover:bg-gray-800 transition flex items-center gap-2">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="border border-gray-200 rounded-xl p-6 hover:border-black hover:shadow-sm transition-all cursor-pointer group">
                  <div className="flex items-start justify-between">
                    <div><h3 className="font-semibold mb-2">{s.title}</h3><p className="text-sm text-gray-500 leading-relaxed">{s.desc}</p></div>
                    <ArrowRight size={16} className="text-gray-300 group-hover:text-black transition mt-1 shrink-0 ml-4" />
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Team */}
          <div className="mb-24">
            <div className="flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-gray-400 mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="group cursor-pointer">
                  <div className={`${m.bg} rounded-2xl h-56 mb-4 overflow-hidden relative`}>
          ...
          {/* Contact */}
          <div className="grid lg:grid-cols-2 gap-16 pt-16 border-t border-gray-100">
            <div>
              <span className="inline-flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-gray-400 mb-4">
                <Mail size={14} /> Contact
              </span>
              <h2 className="text-4xl font-bold leading-tight mb-6">Let&apos;s start a conversation.</h2>
              <p className="text-gray-500 leading-relaxed mb-8">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4">
                    <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600">{c.icon}</div>
                    <div><p className="text-xs text-gray-400">{c.label}</p><p className="text-sm font-medium">{c.value}</p></div>
                  </div>
                ))}
              </div>
            </div>
            <form className="space-y-5" onSubmit={e => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-5">
                <div><label className="text-xs font-medium text-gray-500 block mb-1.5">First Name</label><input type="text" placeholder="James" className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-black transition" /></div>
                <div><label className="text-xs font-medium text-gray-500 block mb-1.5">Last Name</label><input type="text" placeholder="Harlow" className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-black transition" /></div>
              </div>
              <div><label className="text-xs font-medium text-gray-500 block mb-1.5">Email</label><input type="email" placeholder="james@company.com" className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-black transition" /></div>
              <div>
                <label className="text-xs font-medium text-gray-500 block mb-1.5">I&apos;m interested in</label>
                <select className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-black transition text-gray-700">
                  <option>Advisory Services</option><option>Investing / Capital</option><option>Real Estate Development</option><option>Partnership</option><option>Other</option>
                </select>
              </div>
              <div><label className="text-xs font-medium text-gray-500 block mb-1.5">Message</label><textarea rows={4} placeholder="Tell us about your project..." className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-black transition resize-none" /></div>
              <button type="submit" className="w-full bg-black text-white py-3 rounded-lg font-medium hover:bg-gray-800 transition flex items-center justify-center gap-2">
      ...
      {/* Page nav */}
      <div className="py-12 px-6 md:px-12 lg:px-16 border-t border-gray-100">
      ...
      {/* Footer */}
      <footer className="bg-black text-white py-16 px-6 md:px-12 lg:px-16">
        <div className="max-w-7xl mx-auto">
