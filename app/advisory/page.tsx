  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <div className="w-full h-screen flex items-center justify-center p-2 sm:p-3 md:p-5 bg-[#f0f0f0]">
        <section className="relative w-full max-w-[1536px] h-full rounded-[1.2rem] sm:rounded-[1.5rem] md:rounded-[3rem] overflow-hidden shadow-none flex flex-col items-center bg-white/10 group">
          ...
          <div className="relative z-10 w-full h-full flex flex-col items-center">
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6">
              <motion.span
                ...
                className="inline-flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-white/60 mb-4 sm:mb-5"
              >
              ...
              <motion.h1
                ...
                className="text-3xl sm:text-5xl md:text-6xl lg:text-[88px] font-light text-white leading-[1.06] mb-4 sm:mb-5"
              ...
              <motion.p
                ...
                className="text-sm sm:text-base md:text-lg text-white/60 max-w-xs sm:max-w-xl leading-relaxed font-light"
              >
            ...
            <motion.div
              ...
              className="absolute bottom-24 right-4 left-auto md:left-6 md:right-auto md:bottom-6 lg:bottom-10 lg:left-10 p-3 md:p-4 lg:p-5 rounded-[1.2rem] md:rounded-[1.5rem] lg:rounded-[2.2rem] bg-white/30 backdrop-blur-xl flex flex-col gap-2 lg:gap-3 min-w-[130px] md:min-w-[150px] lg:min-w-[180px] w-fit"
            >
              <div className="flex flex-col">
                <span className="text-xl md:text-3xl font-normal text-[rgba(30,50,90,0.9)] tracking-tight">200+</span>
                <span className="text-[9px] md:text-[12px] font-normal text-[rgba(30,50,90,0.6)] uppercase tracking-wider">Advisory Mandates</span>
              </div>
              <motion.button
                whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                className="flex items-center bg-white rounded-full pl-1.5 pr-4 py-1.5 gap-2 hover:bg-white/90 transition-colors self-start group"
              >
                <div className="bg-[rgba(30,50,90,0.1)] p-1 rounded-full flex items-center justify-center">
                  <ArrowUpRight className="w-3 h-3 md:w-3.5 md:h-3.5 text-[rgba(30,50,90,0.9)]" />
                </div>
                <span className="text-[12px] md:text-[14px] font-normal text-[rgba(30,50,90,0.9)]">Work with us</span>
              </motion.button>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-start mb-16 sm:mb-24">
            <div>
              ...
              <button className="bg-black text-white px-6 sm:px-7 py-3 rounded-lg font-medium hover:bg-gray-800 transition flex items-center gap-2 text-sm sm:text-base">
              ...
              {[
                ...
                <div key={i} className="border border-gray-200 rounded-xl p-4 sm:p-6 hover:border-black hover:shadow-sm transition-all cursor-pointer group">
                  <div className="flex items-start justify-between">
                    <div><h3 className="font-semibold mb-1.5 text-sm sm:text-base">{s.title}</h3><p className="text-xs sm:text-sm text-gray-500 leading-relaxed">{s.desc}</p></div>
          ...
          {/* Contact */}
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 pt-12 sm:pt-16 border-t border-gray-100">
            <div>
            ...
            <form className="space-y-4 sm:space-y-5" onSubmit={e => e.preventDefault()}>
              <div className="grid grid-cols-2 gap-3 sm:gap-5">
                <div><label className="text-xs font-medium text-gray-500 block mb-1.5">First Name</label><input type="text" placeholder="James" className="w-full border border-gray-200 rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-sm focus:outline-none focus:border-black transition" /></div>
                <div><label className="text-xs font-medium text-gray-500 block mb-1.5">Last Name</label><input type="text" placeholder="Harlow" className="w-full border border-gray-200 rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-sm focus:outline-none focus:border-black transition" /></div>
              </div>
              <div><label className="text-xs font-medium text-gray-500 block mb-1.5">Email</label><input type="email" placeholder="james@company.com" className="w-full border border-gray-200 rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-sm focus:outline-none focus:border-black transition" /></div>
              <div>
              ...
              <div><label className="text-xs font-medium text-gray-500 block mb-1.5">Message</label><textarea rows={4} placeholder="Tell us about your project..." className="w-full border border-gray-200 rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-sm focus:outline-none focus:border-black transition resize-none" /></div>
      ...
      {/* Page nav */}
      <div className="py-10 sm:py-12 px-4 sm:px-6 md:px-12 lg:px-16 border-t border-gray-100">
